...
def text_predictor(repository,costumer_query):
    ...
    """
    This function outputs a maximun of three keywords suggestions (from a given repository) after each character is typed by the costumer in the search field.

    If there are more than three aceptable keywords, the functions returns the keywords that are first in alphabetical order. Furthermore, 
    the function starts suggesting keywords after the costumer has entered two characters.  
    """
